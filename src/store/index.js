...
import { arbitrator, knight, dragon, goblin, cave, deck, player, lobby, game } from './modules'
import { reorient, connectionsMap } from '../utils'
...
export default new Vuex.Store({
  ...
  actions: {
    ...
    movePiece ({state, commit}, action){
      ...
      console.log('we gonna have', startCell.tokens, Object.assign({}, startCell.tokens, {[piece]: false}))
